...
- 🎓 Member of the **ESIEA School** organization.
- 💻 I am particularly interested in developing games and interactive experiences, especially using **Unity** and Extended Reality (**XR**).
- 🛠️ I have also worked on network architectures.
- 🎮 I am an amazing toplaner

## 🛠 Technologies & Tools

*Based on my recent projects:*

- **Engines & Frameworks:** Unity 3D, XR (AR/VR)
- **Languages:** C# (Unity), C/C++ (ESIEA)
